...
def puntos1(request):
    ...
    while True:
        try:
            ...
            print("Dato 1")
            print("------------------------")
            leer_datos(list_in_floats, arduino)               # Llamo la función de lectura de datos on un argumento de la lista donde guardo los datos 
            try:
...
def leer_datos (list_in_floats, arduino):
    list_values = []
    time.sleep(5)
    print("Ponle el peso")
